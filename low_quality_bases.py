...
def trim_single_read_low_quality_bases(fname, 
    ...
    """
    trim_single_read_low_quality_bases trims off the low quality bases according to the subread_func
    and cutoff given.
    """
...
def trim_paired_read_low_quality_bases(fname1, fname2,
    ...
    """
    trim_paired_read_low_quality_bases trims off the low quality bases according to the subread_func
    and cutoff given. 
